...
[ HighLevel Support Portal ](https://help.gohighlevel.com)
  ...
  * 
  ...
  6. Allow duplicate contact explained
...
Modified on: Fri, 23 Apr, 2021 at 5:04 PM

The Allow duplicate contact option only applies to contact coming from **__Zapier / other Forms__**. So we **won't  **be able to create two contacts with the same email or phone number from the **CSV contact upload**. When importing contact, by default, We create contacts and merge based on the **contact's phone number or email address**. 
